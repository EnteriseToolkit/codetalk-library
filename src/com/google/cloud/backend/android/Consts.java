...
public interface Consts {
   ...
   */
  public static final boolean DEBUG = QRCloudUtils.DEBUG;

  /**
   * Set Project ID of your Google APIs Console Project.
   */
  public static final String PROJECT_ID = "*** YOUR PROJECT ID ***"; // TODO: add your project id

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "*** YOUR PROJECT NUMBER ***"; // TODO: add your project number

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "*** YOUR WEB CLIENT ID ***"; // TODO: add your web client id
